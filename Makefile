...
all: lisp-zero-single zero-single-test
...
lisp-zero-single-opt: lisp-zero-single.c
	gcc -O3 -Wall -W -I/usr/share/gnulib/lib -o lisp-zero-single-opt lisp-zero-single.c
...
zero-single-opt-test: zero-test.gold zero-single-opt-test.out
	diff -u zero-test.gold zero-single-opt-test.out

zero-single-opt-test.out: lisp-zero-single-opt zero-test.lisp
	./lisp-zero-single-opt zero-test.lisp > zero-single-opt-test.out
...
clean:
	rm -f lisp-zero lisp-zero-single lisp-zero-single-opt zero-test.out zero-single-test.out zero-single-opt-test.out
